	...
	$(function () {
     $("#table_sistema").DataTable().destroy();
       ...
       $("#subtitulo").text('Lista de Especialidades');
    });

function nuevo(){
     reload();
           $("#subtitulo").text('Nueva de Especialidad');
     $.get(base_url+"Especialidad/nuevo",function(data){
...
function modificar(id){
	/*$("#titulo").text("Modificar cliente en "+empresa);*/ reload();
     $("#subtitulo").text('Actualizar de Especialidad');
     		$.post(base_url+"Especialidad/actualizar",{'id':id},function(data){
