...
<input type="hidden" name="id_tipo_norma" value="<?php echo $id_tipo_norma; ?>">
	<div class="row">
		<div class="form-group">
			<label class="control-label col-lg-2">Nombre del Tipo de norma<span class="text-danger">*</span></label>
				<div class="col-lg-10">
	...
	<div class="row">
	 <div class="form-group">
      ...
      <center>
      	 ...
      	 onclick="reload_url('Tipo_norma','mantenimiento')");">Cancelar</button>
      	 </center>
      </div>
</form>
	</div>
