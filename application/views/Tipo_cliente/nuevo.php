...
<input type="hidden" name="id_tipocliente" value="<?php echo $id_tipocliente; ?>">
	<div class="row">
		<div class="form-group">
			<label class="control-label col-lg-2">Nombre del tipo de cliente<span class="text-danger">*</span></label>
				<div class="col-lg-10">
	...
	<div class="row">
	 <div class="form-group">
      ...
      <center>
      	 ...
      	 onclick="reload_url('Tipo_cliente','mantenimiento')");">Cancelar</button>
      	 </center>
      </div>
</form>
	</div>
