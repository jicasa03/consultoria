<?php
	class Mantenimiento_m extends CI_Model
	{
        ...
        public function asesores($idsede)
        {
         ...
         $datasesores=$this->db->query("SELECT persona.nombres,persona.apellidos,persona.dni from usuario,trabajador,persona WHERE usuario.persona=persona.dni and persona.dni=trabajador.dni and usuario.usu_perfil=2 and usuario.usu_sede=".$idsede);
